...
// ============================================================
// 표시 범위: 본토 + 제주 (울릉도/백령도 같은 원거리 부속섬은 KOREA_PROVINCES 데이터엔 있지만
// 화면 범위 밖이라 렌더링되지 않음 - 캠핑장이 없는 지역까지 넣으면 지도가 과하게 넓어져 제외)
const MAP_CONFIG = {
  lonMin: 125.0,
  lonMax: 129.6,
  latMin: 33.0,
...
const CAMPSITES = [
  ...
  { id: 'c12', name: '안면도자연휴양림', region: '충남 태안', lat: 36.52, lon: 126.33, price: 19000, capacity: 4, rating: 4.6, tags: ['자연휴양림', '숲세권'], emoji: '🌲', theme: 'forest', desc: '안면도 소나무 숲 사이에 자리한 휴양림으로 산림욕에 좋습니다.' },
  ...
  { id: 'c16', name: '완도수목원 야영장', region: '전남 완도', lat: 34.36, lon: 126.78, price: 15000, capacity: 4, rating: 4.4, tags: ['수목원', '숲세권'], emoji: '🌳', theme: 'forest', desc: '다양한 난대림을 관찰할 수 있는 수목원 내 야영장입니다.' },
